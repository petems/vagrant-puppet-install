      ...
      class InstallPuppet
        ...
        def default_install_url
          if @machine.config.puppet_install.puppet_version.nil?
            ...
            if @machine.config.puppet_install.puppet_version == 'latest' || @machine.config.puppet_install.puppet_version.match(/^8\..+/)
              'https://raw.githubusercontent.com/petems/puppet-install-shell/master/install_puppet_8_agent.sh'
            elsif @machine.config.puppet_install.puppet_version.match(/^7\..+/)
